      ...
      <div className="flex flex-wrap gap-4 mb-6 px-2 md:px-0">
        ...
        <div className="relative w-full md:w-auto">
          <input
            ...
            className="bg-gray-50 transition-all shadow-md border border-gray-100 px-4 py-2 pl-10 focus:border-[#76ca99]
              min-w-80 focus:outline-[#76ca99] w-full md:w-auto appearance-none rounded-lg"
          />
